...
template <typename Tk, typename Tv, bool Order>
void clause_multibag_insert(int N, Multibag<Tk, Tv, Order> *mmap) {
  if (mmap->N_ == N) {
    return;
  }
  mmap->N_ = N;
...
public:
  ...
  friend void clause_multibag_insert<Tk, Tv>(int N,
                                             Multibag<Tk, Tv, Order> *mmap);
  ...
  class KeysView {
  public:
    KeysView(Multibag<Tk, Tv, Order> &mmap) : mmap_(mmap) {}
  ...
  void insert(Tk key, const Tv &value) {
    ...
    auto p = noelle_pragma_begin("ldtc",
                                 &k,
                                 0,
                                 clause_multibag_insert<Tk, Tv, Order>,
                                 this);
...
using OrderedMultibag = Multibag<Tk, Tv, /*Order=*/true>;

template <typename Tk, typename Tv>
using UnorderedMultibag = Multibag<Tk, Tv, /*Order=*/false>;
